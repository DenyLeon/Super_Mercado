...
public:
	...
	Venta(string id_ven, string no_fac, string ser, string fech_fac, string id_cli, string id_emp, string fech_ing, string idv_d, string idprod, string cant, int pre_unit) {
		idventa = id_ven;
		no_factura = no_fac;
		serie = ser;
	...
	void setprecio_unitario(int pre_unit) { precio_unitario = pre_unit; }
	...
	int getprecio_unitario() { return precio_unitario; }
	...
	void crear() {
		...
		if (cn.getConectar()){
		string insert = "INSERT INTO `proyecto`.`ventas`(no_factura, serie, fecha_factura, idClientes, idEmpleado, fecha_ingreso)VALUES('" + no_factura + "','" + serie + "','" + fecha_factura + "','" + idcliente + "','" + idempleado + "','" + fechaingreso + "'); ";
		...
		string insert2 = "INSERT INTO `proyecto`.`ventas_detalle`(idVenta, idProducto, cantidad, precio_unitario)VALUES('" + idventa + "','" + idproducto + "','" + cantidad + "'," + p_u + "); ";
	...
	void Actualizar() {
		...
		if (cn.getConectar()) {
			...
			string update2 = "UPDATE `ventas_detalle` SET`idVenta` = '" + idventa + "' ,`idProducto` = '" + idproducto + "',`cantidad` ='" + cantidad + "',`precio_unitario` = " + p_u + " WHERE (`idventa_detalle` = '" + idventa_detalle + "');";
