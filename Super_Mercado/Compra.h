...
public:
	...
	void crear() {
		...
		if (cn.getConectar()) {
			string insert = "INSERT INTO `proyecto`.`compras`(no_orden_compra, id_proveedor, fecha_orden, fechaingreso)VALUES('" + orden_compra + "','" + id_proveedor + "','" + fecha_orden + "','" + fecha_ingreso + "'); ";
			...
			string insert2 = "INSERT INTO `proyecto`.`compras_detalle`(idcompra, idproducto, cantidad, precio_costo_unitario)VALUES('" + idcompradetalle + "','" + idproducto + "','" + cantidad + "','" + costounitario + "'); ";
